...
int main() {
    ...
    char* exe_path_c = &exe_path[0];
    std::string exe_dir = dirname(exe_path_c);
    char* exe_dir_c = &exe_dir[0];
    std::string base_dir = dirname(exe_dir_c);
    std::string mnist_path = base_dir + "/demonstration model/mnist/";
...
void run_snake_visualization() {
    std::cout << "\n--- Snake Visualization ---\n" << std::endl;
    const std::string model_path = "weights/snake-dqn-final.bin";
